...
export default function VirtualList() {
  ...
  const anchorItem = useRef({ /* 锚点元素 */
    index: 0,
    startOffset: 0, // 锚点元素的顶部距离第一个元素的顶部的偏移量
  })
  ...
  const handleScroll = () => {
    ...
    const currentOffset = scrollTop - (scrollTop % itemHeight); // Math.floor(scrollTop / itemHeight) * itemHeight
